                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li class="{{ areActiveRoutes(['orders.index.admin', 'orders.show'])}}">
                            <a class="nav-link" href="{{ route('prescription') }}">
                                <i class="fa fa-shopping-basket"></i>
                                <span class="menu-title">{{translate('Prescription')}} @if($prescription > 0)<span class="pull-right badge badge-info">{{ $prescription }}</span>@endif</span>
                            </a>
                        </li>
                        @endif
                        ...
                        @if (\App\Addon::where('unique_identifier', 'affiliate_system')->first() != null)
                            <li>
                                <a href="#">
                                    ...
                                    @if($affilatecount > 0)<span class="pull-right badge badge-danger">{{ $affilatecount }}</span> @endif
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['affiliate.users', 'affiliate_users.show_verification_request', 'affiliate_user.payment_history'])}}">
                                        <a class="nav-link" href="{{route('affiliate.users')}}">{{translate('Affiliate Users')}}   @if($affilatecount > 0)<span class="pull-right badge badge-danger">{{ $affilatecount }}</span> @endif </a>
                                    </li>
