...
<div class="row">
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                <div class="dash-widget-vertical">
                    <div class="rorate">{{translate('Affilators')}}</div>
                </div>
                <br>
                <p class="text-normal text-main">{{translate('Total Affilators')}}</p>
                <p class="text-semibold text-3x text-main">{{ \App\AffiliateUser::all()->count() }}</p>
                <br>
                <a href="{{route('affiliate.users')}}" class="btn-link">{{translate('Manage Affilators')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{translate('Total approved Affilators')}}</p>
                <p class="text-semibold text-3x text-main">{{ \App\AffiliateUser::where('status', '=', '1')->get()->count() }}</p>
                <br>
                <a href="{{route('affiliate.users')}}" class="btn-link">{{translate('Manage Affilators')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{translate('Total pending Affilators')}}</p>
                <p class="text-semibold text-3x text-main">{{ \App\AffiliateUser::where('status', '=', '0')->count() }}</p>
                <br>
                <a href="{{route('affiliate.users')}}" class="btn-link">{{translate('Manage Affilators')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
